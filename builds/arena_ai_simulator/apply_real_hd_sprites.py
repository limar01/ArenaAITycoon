...
Location on Phone: ~/projects/hermes_game_studio/builds/castlevania_stage1/apply_real_hd_sprites.py
"""
...
<title>Arena AI Simulator: Studio Life - Real HD PNG Sprites</title>
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; user-select: none; -webkit-user-select: none; }
  ...
  canvas { background: #000; image-rendering: pixelated; image-rendering: crisp-edges; -ms-interpolation-mode: nearest-neighbor; width: 100%; height: auto; aspect-ratio: 4 / 3; border: 4px solid #6820b0; box-shadow: 0 0 35px rgba(184, 120, 248, 0.8); touch-action: none; }
...
<div id="game-container">
  <div id="hud-bar">
    <div>🏛️ ARENA AI SIMULATOR (REAL HD PNG SPRITES)</div>
    <div>
...
const agents = [
  { id: 'zillion', name: 'Zillion', role: 'Tech Director', x: 220, y: 100, targetX: 100, targetY: 80, sx: 0, sy: 0, phrase: 'Real HD PNG Sprite Atlas Engine Active!' },
  ...
  { id: 'cody', name: 'Cody', role: 'Programmer', x: 460, y: 120, targetX: 500, targetY: 80, sx: 3, sy: 0, phrase: 'qwen2.5-coder multi-model engine active!' },
...
// REAL HD PNG SPRITE RENDERING ENGINE
function render() {
  // CRITICAL: Crisp pixel-art scaling
  ...
  // 1. Draw HD Generated Top-Down Office Layout Image
  ...
  // 2. Render Real HD Character Sprites from PNG Atlas Sheet
  for (let a of agents) {
    ...
    if (spriteSheetImg.complete && spriteSheetImg.naturalWidth > 0) {
      ...
      // Draw HD PNG Pixel Sprite Directly from Atlas!
